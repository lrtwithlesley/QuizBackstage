    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item>
            <el-button type="success" @click="onSubmit">查询题目</el-button>
          </el-form-item>
        ...
        <el-dialog title="添加新题目" :visible.sync="dialogFormVisible">
          <el-form :model="form" label-width="80px">
            <el-form-item label="题目">
              <el-input v-model="form.question" style="width: 500px"></el-input>
            </el-form-item>

            <el-form-item label="选项A">
              <el-input v-model="form.optiona" style="width: 500px"></el-input>
            </el-form-item>

            <el-form-item label="选项B">
              <el-input v-model="form.optionb" style="width: 500px"></el-input>
            </el-form-item>

            <el-form-item label="选项C">
              <el-input v-model="form.optionc" style="width: 500px"></el-input>
            </el-form-item>

            <el-form-item label="选项D">
              <el-input v-model="form.optiond" style="width: 500px"></el-input>
            </el-form-item>

            <el-form-item label="答案">
              <el-input v-model="form.answer" style="width: 500px"></el-input>
            </el-form-item>
          </el-form>
